...
namespace ConfInfrastructure.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public TicketsController(DbconappContext context)
        {
            _context = context;
        }
        ...
        {
            var dbconappContext = _context.Tickets.Include(t => t.Conference).Include(t => t.User);
        ...
        public async Task<IActionResult> Create([Bind("Date,Place,Price,ConferenceId,UserId,Id")] Ticket ticket)
        {
            ...
            ViewData["ConferenceId"] = new SelectList(_context.Conferences, "Id", "Description", ticket.ConferenceId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Date,Place,Price,ConferenceId,UserId,Id")] Ticket ticket)
        {
            if (id != ticket.Id)
            {
                return NotFound();
