...
namespace ConfInfrastructure.Controllers
{
    public class PublicationsController : Controller
    {
        ...
        public PublicationsController(DbconappContext context)
        {
            _context = context;
        }
        ...
        {
            var dbconappContext = _context.Publications.Include(p => p.User);
        ...
        public async Task<IActionResult> Create([Bind("Title,UserId,UploadDate,Id")] Publication publication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Title,UserId,UploadDate,Id")] Publication publication)
        {
