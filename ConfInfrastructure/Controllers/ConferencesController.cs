...
namespace ConfInfrastructure.Controllers
{
    public class ConferencesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Organizators", "Index", new { id = conference.Id, name = conference.Title });
        }
        ...
        public async Task<IActionResult> Create([Bind("Title,Description,OrganizatorId,Date,PublicationDeadline,PublicationId,Id")] Conference conference)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Title,Description,OrganizatorId,Date,PublicationDeadline,PublicationId,Id")] Conference conference)
        {
            if (id != conference.Id)
            {
                return NotFound();
